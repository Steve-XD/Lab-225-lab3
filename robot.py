...
class Robot:
    ...
    def __init__(self):
        ...
        self._state = Robot.State(Direction.NORTH, 10, 1)
    ...
    def move(self):
        error = (self._state.direction == Direction.NORTH and self._state.row == 1) or \
                (self._state.direction == Direction.EAST and self._state.col == 1) or \
                (self._state.direction == Direction.SOUTH and self._state.row == 10) or \
                (self._state.direction == Direction.WEST and self._state.col == 10)
        if error:
